	...
	static public function ctrEnviarFacturaCorreo(){
		...
		if (isset($_GET["idFacturaEnviarCorreo"])) {
			...
			try {
				...
				self::enviarCorreo("facturacion@qwerty-systems.com", "rrivas2@hotmail.com", $subject, $message, $pdfUrl, $factura["firmaDigital"], $jsonContent.$factura["firmaDigital"]);
				self::enviarCorreo("facturacion@qwerty-systems.com", $cliente["correo"], $subject, $message, $pdfUrl, $factura["firmaDigital"], $jsonContent.$factura["firmaDigital"]);
